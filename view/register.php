...
<div class="form_dang_nhap_2">
        ...
        <form>
            <h2>Đăng kí</h2>
            <div><p>Đã có tài khoản:</p><a style="text-decoration: none;" href="index.php?pg=product&action=login" class="dang_ki"> Đăng nhập tại đây</a></div>
            <input type="email" id="email" name="ho" placeholder="Họ" required>
            <input type="email" id="email" name="ten" placeholder="Tên" required>
            <input type="email" id="email" name="email" placeholder="Email" required>
            <input type="email" id="email" name="sdt" placeholder="Số điện thoại" required>
