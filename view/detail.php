...
<head>
    ...
    <link rel="icon" href="https://cdn.haitrieu.com/wp-content/uploads/2021/11/Logo-The-Gioi-Di-Dong-MWG.png">
...
<div class="my-product">
        <div class="title"><a href="">Điện thoại</a><i class='bx bx-chevron-right'></i><a href="">Điện thoại IPhone</a>
        </div>
        <div class="container-show-product">
            <div class="title-product">
                <span style="width: 38%; font-size: 19px; font-weight: 600;">Iphone 15 thường 128GB</span>
                ...
                <div id="carouselExample" class="carousel slide">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="./public/DuAn_Group-4people/images/product-kecuoi-sp1.jpg" class="d-block w-10" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="./public/DuAn_Group-4people/images/banner-2.jpg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="./public/DuAn_Group-4people/images/banner-3.jpg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="./public/DuAn_Group-4people/images/banner-4.jpg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="./public/DuAn_Group-4people/images/banner-5.jpg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="./public/DuAn_Group-4people/images/banner-6.jpg" class="d-block w-100" alt="...">
                        </div>
                    </div>
                    ...
                    <div class="image-product">
                        ...
                        <div class="container-image">
                            <div class="image"><img src="./public/DuAn_Group-4people/images/chitietsanpham-iphone-15-pink.jpg" alt="">
                            </div>hồng nhạt
                        </div>
                        <div class="container-image">
                            <div class="image"><img src="./public/DuAn_Group-4people/images/chitietsanpham-iphone-15-plus-xanh-la-128gb.jpg" alt="">
                            </div>xanh lá
                        </div>
                        <div class="container-image">
                            <div class="image"><img src="./public/DuAn_Group-4people/images/chitietsanpham-iPhone-15-thumb-tim.jpg" alt="">
                            </div>Tím
                        </div>
                        <div class="container-image">
                            <div class="image"><img src="./public/DuAn_Group-4people/images/chitietsanpham-iPhone-15-plus-thumb-xanhduong.jpg" alt="">
                            </div>xanh dương
                        </div>
                        <div class="container-image">
                    ...
                    <div class="image-detail">
                        <img src="./public/DuAn_Group-4people/images/chitietsanpham-iphone-15-pink.jpg" alt="" style="height: 100%;">
                    </div>
                    <div class="product-information">
                        <div class="title" style="font-weight: 600;">Thông tin sản phẩm</div>
                        <p style="font-weight: 400;"><span style="color: rgb(0, 108, 216);">Iphone 15 thường 8G
                                512GB</span> là một sản phẩm công nghệ không còn xa lạ với những người yêu công nghệ.
                        ...
                        <p style="font-size: 16px;">Iphoen 15 thường sẽ được sử dụng lối thiết kế bo cong ở mặt lưng
                ...
                <div class="select">
                    ...
                    <div class="price">
                        ...
                        <div class="my-card">
                            ...
                            <div class="title">
                                <div style="font-size: 25px; font-weight: 600;">25.490.000₫</div>
                                <div>23:00 | 15/08</div>
                            </div>
                            <div class="title">
                                <div style="font-size: 14px; text-decoration-line: line-through;">36.990.000₫</div>
                        ...
                        <div class="parameter-title">
                            Cấu hình Điện thoại Iphoen15 thường 8G 512GB
                        </div>
    ...
    <div class="text">
        <div>Phụ kiện thường mua cùng</div><a href=""
            >Xem tất cả</a>
    </div>
    <nav class="product-two">
        <div class="product-two-content-items">
            <div class="product-two-content-item">
                <img src="./public/DuAn_Group-4people/images/phu-kien-1.jpeg" alt="">
        ...
        <div class="product-two-content-items">
            <div class="product-two-content-item">
                <img src="./public/DuAn_Group-4people/images/phu-kien-2.jpeg" alt="">
                <div class="product-two-content-item-text">
                    <li class="pricecheap">
                        GIÁ RẺ QUÁ
                    </li>
        ...
        <div class="product-two-content-items">
            <div class="product-two-content-item">
                <img src="./public/DuAn_Group-4people/images/phu-kien-3jpeg.jpg" alt="">
                <div class="product-two-content-item-text">
                    <li class="pricecheap">
                        GIÁ RẺ QUÁ
                    </li>
        ...
        <div class="product-two-content-items">
            <div class="product-two-content-item">
                <img src="./public/DuAn_Group-4people/images/phu-kien-4.jpg" alt="">
                <div class="product-two-content-item-text">
                    <li class="pricecheap">
                        GIÁ RẺ QUÁ
                    </li>
        ...
        <div class="product-two-content-items">
            <div class="product-two-content-item">
                <img src="./public/DuAn_Group-4people/images/phu-kien-5.jpg" alt="">
                <div class="product-two-content-item-text">
                    <li class="pricecheap">
                        GIÁ RẺ QUÁ
                    </li>
